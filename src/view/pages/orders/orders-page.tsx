            ...
            <table className="w-full text-right text-sm">
              <thead>
                <tr className="border-b text-[var(--erp-muted)]">
                  <th className="py-3 pr-4 whitespace-nowrap">رقم الطلب</th>
                  <th className="py-3 whitespace-nowrap">العميل</th>
                  <th className="py-3 whitespace-nowrap">العنوان</th>
                  <th className="py-3 whitespace-nowrap">النقاط المستخدمة</th>
                  <th className="py-3 whitespace-nowrap">الحالة</th>
                  <th className="py-3 whitespace-nowrap">تحديث الحالة</th>
                  <th className="py-3 pl-4 whitespace-nowrap">التفاصيل</th>
                </tr>
              </thead>
